...
var textContainer = document.querySelector("#parallaxContainer2");
...
function setTranslate3DTransform(element, yPosition) {
    ...
    var value2 = 'rotateX(' + -1*yPosition/5 + 'deg)';
    var scale = -1*(yPosition/200);
    if(scale < .75){ scale = .75};
    var value3 = 'scale(' + scale + ')';
    var value4 = 'rotateX(' + -1*(yPosition/3) + 'deg)';
    var value5 = "translate3d(0px" + ", " + (yPosition*-1)/5 + "px" + ", 0)";
   ...
   // element.style[transformProperty] = value;
    ...
    element.style[transformProperty] = value2;
   
   // textContainer.style[transformProperty] = value4;
   
    textContainer.style[transformProperty] = value5;
